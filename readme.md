...
import { Ocean } from 'https://cdn.spooky.click/ocean/1.2.5/mod.js';
...
```js
import { Ocean } from 'https://cdn.spooky.click/ocean/1.2.5/mod.bundle.js';
```
...
```js
import 'https://cdn.spooky.click/ocean/1.2.5/shim.js';
...
```js
import { HydrateLoad, Ocean } from 'https://cdn.spooky.click/ocean/1.2.5/mod.js';
...
```js
import { HydrateIdle, Ocean } from 'https://cdn.spooky.click/ocean/1.2.5/mod.js';
...
```js
import { HydrateMedia, Ocean } from 'https://cdn.spooky.click/ocean/1.2.5/mod.js';
...
```js
import { HydrateVisible, Ocean } from 'https://cdn.spooky.click/ocean/1.2.5/mod.js';
