...
```js
import 'https://cdn.spooky.click/ocean/1.1.3/shim.js?global';
import { Ocean } from 'https://cdn.spooky.click/ocean/1.1.3/mod.js';
...
```js
import { Ocean } from 'https://cdn.spooky.click/ocean/1.1.3/mod.bundle.js';
```
...
```js
import 'https://cdn.spooky.click/ocean/1.1.3/shim.js';
...
import {
  ...
  HydrateVisible,
  Ocean
} from 'https://cdn.spooky.click/ocean/1.1.3/mod.js';
```
...
```js
import { HydrateLoad, Ocean } from 'https://cdn.spooky.click/ocean/1.1.3/mod.js';
...
```js
import { HydrateIdle, Ocean } from 'https://cdn.spooky.click/ocean/1.1.3/mod.js';
...
```js
import { HydrateMedia, Ocean } from 'https://cdn.spooky.click/ocean/1.1.3/mod.js';
...
```js
import { HydrateVisible, Ocean } from 'https://cdn.spooky.click/ocean/1.1.3/mod.js';
